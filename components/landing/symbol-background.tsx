...
export const SymbolBackground = () => {
    ...
    return (
        <div className="fixed inset-0 z-0 pointer-events-none bg-black overflow-hidden font-mono leading-none select-none">
            ...
            <div className="absolute top-[20%] left-[10%] w-[520px] h-[520px] bg-white/5 rounded-full blur-[140px]" />
            <div className="absolute bottom-[20%] right-[10%] w-[520px] h-[520px] bg-zinc-700/20 rounded-full blur-[160px]" />

            {/* Scanline effect */}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.28)_50%),linear-gradient(90deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02),rgba(255,255,255,0.05))] bg-[length:100%_2px,4px_100%] z-20 pointer-events-none" />
        </div>
    )
}
