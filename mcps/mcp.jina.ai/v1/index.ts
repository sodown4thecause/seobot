...
import { search_ssrnToolWithClient } from "./search_ssrn.js";
import { search_jina_blogToolWithClient } from "./search_jina_blog.js";
...
import { parallel_search_ssrnToolWithClient } from "./parallel_search_ssrn.js";
...
import { extract_pdfToolWithClient } from "./extract_pdf.js";
...
export const mcpJinaTools = {
  ...
  search_ssrn: search_ssrnToolWithClient(getMcpClient),
  search_jina_blog: search_jina_blogToolWithClient(getMcpClient),
  ...
  parallel_search_ssrn: parallel_search_ssrnToolWithClient(getMcpClient),
  ...
  extract_pdf: extract_pdfToolWithClient(getMcpClient),
} as const;
...
export const mcpJinaToolsWithClient = (client: Promise<Client> | Client) =>
  ({
    ...
    search_ssrn: search_ssrnToolWithClient(() => client),
    search_jina_blog: search_jina_blogToolWithClient(() => client),
    ...
    parallel_search_ssrn: parallel_search_ssrnToolWithClient(() => client),
    ...
    extract_pdf: extract_pdfToolWithClient(() => client),
  }) as const;
...
export const search_ssrnTool = search_ssrnToolWithClient(getMcpClient);
export const search_jina_blogTool =
  search_jina_blogToolWithClient(getMcpClient);
...
export const parallel_search_ssrnTool =
  parallel_search_ssrnToolWithClient(getMcpClient);
...
export const extract_pdfTool = extract_pdfToolWithClient(getMcpClient);
