...
export async function suggestions(params: DataForSEORequest): Promise<DataForSEOResponse<KeywordSuggestion[]>> {
  ...
  return dataForSEOClient.fetchWithLongCache(KEYWORD_ENDPOINTS.SUGGESTIONS, requestParams)
}
