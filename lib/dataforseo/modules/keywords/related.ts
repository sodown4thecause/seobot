...
export async function related(params: DataForSEORequest): Promise<DataForSEOResponse<KeywordSuggestion[]>> {
  ...
  return dataForSEOClient.fetchWithLongCache(KEYWORD_ENDPOINTS.RELATED, requestParams)
}
