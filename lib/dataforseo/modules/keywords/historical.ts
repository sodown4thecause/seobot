/**
 * Historical Search Volume Module
 */
...
export async function historical(params: DataForSEORequest): Promise<DataForSEOResponse<KeywordData[]>> {
  ...
  return dataForSEOClient.fetchWithVeryLongCache(KEYWORD_ENDPOINTS.HISTORICAL, requestParams)
}
