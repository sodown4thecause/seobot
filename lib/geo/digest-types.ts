...
export type DigestSectionStatus = z.infer<typeof digestSectionStatusSchema>
...
export type GeoHealthResponse = z.infer<typeof geoHealthResponseSchema>
export type JobRunRecord = z.infer<typeof jobRunRecordSchema>

export function parseDailyDigestDocument(value: unknown): DailyDigestDocument {
  return dailyDigestDocumentSchema.parse(value)
}

export function parseGeoSuggestions(value: unknown): GeoSuggestions {
  return geoSuggestionsSchema.parse(value)
}
