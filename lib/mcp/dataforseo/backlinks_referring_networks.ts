...
// Auto-generated wrapper for MCP tool: backlinks_referring_networks
// Source: https://mcp.dataforseo.com/http
export const backlinks_referring_networksToolWithClient = (
...
default value: ip`,
      ...
      limit: z
        ...
        .gte(1)
        .lte(1000)
        .describe("the maximum number of returned networks")
        .default(10),
      offset: z
        .number()
        .gte(0)
