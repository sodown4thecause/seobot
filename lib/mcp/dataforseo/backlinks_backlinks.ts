...
// Auto-generated wrapper for MCP tool: backlinks_backlinks
// Source: https://mcp.dataforseo.com/http
export const backlinks_backlinksToolWithClient = (
...
default value: as_is`,
      ...
      limit: z
        ...
        .gte(1)
        .lte(1000)
        .describe("the maximum number of returned backlinks")
        .default(10),
      offset: z
        .number()
        .gte(0)
