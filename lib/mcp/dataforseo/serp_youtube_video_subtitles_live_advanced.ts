...
// Auto-generated wrapper for MCP tool: serp_youtube_video_subtitles_live_advanced
// Source: https://mcp.dataforseo.com/http
export const serp_youtube_video_subtitles_live_advancedToolWithClient = (
...
Location format - hierarchical, comma-separated (from most specific to least)
 ...
 3. City,Region,Country: "San Francisco,California,United States"`),
      ...
      subtitles_language: z
        .string()
        .describe("language code of original text (e.g., 'en')")
        .optional(),
      subtitles_translate_language: z
        .string()
        .describe("language code of translated text (e.g., 'en')")
        .optional(),
      device: z
        .string()
        .describe(
