...
7. [Technical SEO Audit](#technical-seo-audit)
8. [AEO Trust Auditor](#aeo-trust-auditor)
...
The heart of the platform is an intelligent chat interface that serves as your SEO command center.
...
- Ask SEO questions and get instant answers
- Request keyword research with real data
- Generate optimized content on demand
...
Optimize your content to be cited by AI assistants like ChatGPT, Perplexity, Claude, and Gemini.

### AI Platform Tracking

- **Citation Analysis**: Track how often AI platforms cite your content
- **LLM Mention Monitoring**: Monitor brand mentions across AI search platforms
- **Multi-Platform Coverage**: Analyze presence on ChatGPT, Perplexity, Claude, and Gemini

### AEO Tools

| Tool | Description |
|------|-------------|
| `aeoTrackCitations` | Track AI citations for your topic across platforms |
| `findCitationOpportunities` | Discover opportunities to get cited by AI |
| `optimizeForCitations` | Get recommendations to improve AI citability |
| `detectEEATSignals` | Analyze Experience, Expertise, Authoritativeness, Trustworthiness |
| `enhanceEEATSignals` | Generate recommendations to strengthen EEAT |

### AI Search Optimization

- **Direct Answer Formatting**: Structure content to appear as direct answers
- **Snippet Optimization**: Optimize for featured snippets and AI responses
- **FAQ Schema Generation**: Auto-generate FAQ schema for voice assistants
- **Conversational Query Targeting**: Target questions users ask AI assistants

---

## Keyword Research & Analysis

Comprehensive keyword intelligence powered by DataForSEO.

### Core Keyword Tools

- **Search Volume Analysis**: Get accurate Google search volume data
- **Keyword Difficulty Scoring**: Understand ranking difficulty for any keyword
- **CPC & Competition Data**: Commercial metrics for paid search planning
- **Trend Analysis**: Historical trends and seasonality patterns
...
| **Related Keywords** | Find semantically related terms |
| **Keyword Questions** | Discover question-based queries |
| **Long-tail Finder** | Identify low-competition long-tail opportunities |
| **Search Intent Analysis** | Classify keywords by user intent |
| **SERP Features** | See what SERP features appear for keywords |

### Bulk Analysis

- Import and analyze thousands of keywords at once
- Export data in multiple formats
- Filter and sort by volume, difficulty, CPC, and more

---

## Competitor Analysis

Understand and outperform your competition with deep competitive intelligence.

### Domain Analysis

- **Domain Overview**: Get comprehensive metrics for any domain
- **Organic Traffic Estimation**: Estimate competitor traffic
- **Top Keywords**: See keywords competitors rank for
- **Top Pages**: Identify their best-performing content
...
- **Page Intersection**: Discover overlapping ranking keywords
- **Subdomain Analysis**: Analyze competitor subdomain strategies

### Backlink Intelligence

- **Backlink Profile**: Analyze competitor backlinks
- **Referring Domains**: See who links to competitors
- **Domain Intersection**: Find sites linking to multiple competitors
- **Anchor Text Analysis**: Understand competitor link building strategies

---

## AI Content Generation

Create SEO-optimized, EEAT-compliant content using a sophisticated multi-agent pipeline.

### RAG Writer Orchestrator

The content generation system uses a Research-Augmented Generation (RAG) approach:
...
- **DataForSEO Score**: Technical SEO optimization
- **EEAT Score**: Expertise and trustworthiness
- **Depth Score**: Content comprehensiveness
- **Factual Score**: Accuracy and citations
...
Comprehensive link building automation and prospecting.

### Link Prospect Finder

Discover link opportunities through multiple strategies:

| Strategy | Description |
|----------|-------------|
| **Competitor Backlink Intersection** | Sites linking to multiple competitors but not you |
| **Unlinked Brand Mentions** | Find mentions of your brand without links |
| **Broken Link Opportunities** | Dead links you can replace |
| **Guest Post Sites** | Publications accepting guest content |
| **Resource Pages** | Curated resource lists in your niche |
...
Identify opportunities where competitors outperform you.

### Gap Discovery

- Find keywords competitors rank for that you don't
- Identify topic clusters you're missing
- Analyze content depth differences
- Discover quick-win opportunities

### Topic Clustering

- Automatic grouping of related keywords
- Priority scoring for clusters
...
Step-by-step campaign execution for complex SEO tasks.

### Available Workflows

| Workflow | Description |
|----------|-------------|
| **Ranking Campaign** | Full campaign to rank for target keywords |
| **Link Building Campaign** | Structured outreach and link acquisition |
| **Local SEO Campaign** | Complete local search optimization |
