...
const validProductionEnv = {
  ...
  NEXT_PUBLIC_POSTHOG_KEY: 'phc_flowintent-production',
  ...
  REDDIT_CLIENT_ID: 'flowintent-reddit-client',
  REDDIT_CLIENT_SECRET: 'live-reddit-client-secret',
  UPSTASH_REDIS_REST_URL: 'https://redis.flowintent.com',
  UPSTASH_REDIS_REST_TOKEN: 'live-upstash-token',
  INNGEST_EVENT_KEY: 'live-inngest-event-key',
  INNGEST_SIGNING_KEY: 'live-inngest-signing-key',
}
...
describe('validateEnvironment', () => {
  ...
  it('rejects missing production values', () => {
    expect(validateEnvironment({}, 'production').errors).toEqual(expect.arrayContaining([
      ...
      'Missing required variable: NEXT_PUBLIC_POSTHOG_KEY',
      'Missing required variable: REDDIT_CLIENT_SECRET',
      'Missing required variable: UPSTASH_REDIS_REST_URL',
      'Missing required variable: INNGEST_SIGNING_KEY',
    ]))
  })
